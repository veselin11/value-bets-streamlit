...
def main():
    ...
    with tab2:  
        ...
        with col1:  
            ...
            raw_home_matches = get_team_stats(home_team)
            home_matches = raw_home_matches[-10:] if raw_home_matches else []
            if home_matches:  
        ...
        with col2:  
            ...
            raw_away_matches = get_team_stats(away_team)
            away_matches = raw_away_matches[-10:] if raw_away_matches else []
            if away_matches:  
