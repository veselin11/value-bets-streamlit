...
LANGUAGES = {
    "Български": {
        ...
        "kelly_title": "Кели Калькулатор",
        "bankroll": "Бюджет",
        "confidence": "Доверие (%)",
        "max_stake": "Максимален залог (%)",
        ...
        "no_history": "Няма история на залозите",
        "refresh": "Обнови",
    },
    "English": {
...
def get_live_odds(sport_key):
    try:
        ...
        matches = [m for m in response.json() if validate_match(m)]
        return matches
